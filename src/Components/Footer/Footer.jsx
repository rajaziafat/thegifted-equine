...
const Footer = () => {
  return (
    <>
      <footer className="pt-20 bg-primary">
        <Helmet className="">
          <div className="grid grid-cols-[1fr_300px_1fr] sm:grid-cols-1 sm:gap-y-10">
            <div className="text-white flex flex-col flex-wrap content-center sm:text-center">
            ...
            <div className="text-white flex flex-col flex-wrap content-center">
